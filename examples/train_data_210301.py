...
generator_test_param["train_path"] = os.path.join(
    ...
    "..",
    "sample_data",
    "210301_002_crop.tif",  # "ophys_tiny_761605196.tif", subsamp_ophys_tiny_761605196
)
generator_test_param["batch_size"] = 4  # 5
generator_test_param["start_frame"] = 3800
generator_test_param["end_frame"] = -1
generator_test_param[
    "pre_post_omission"
] = 0  # 1  # Number of frame omitted before and after the predicted frame
...
generator_param["train_path"] = os.path.join(
    ...
    "..",
    "sample_data",
    "210301_002_crop.tif", # 210301_001_crop #############################################################!!!!!
)
generator_param["batch_size"] = 4  # 5
generator_param["start_frame"] = 0
generator_param["end_frame"] = -1
generator_param["N_train"] = 2000  # NEW PARAMETER TO LIMIT TRAINING TO a certain number of frames
generator_param["pre_post_omission"] = 0  # 1
...
] = 1  # 2  # if you want to cycle through the entire data. Two many iterations will cause noise overfitting
training_param["learning_rate"] = 0.0001  # 0.0005  # 0.0001
