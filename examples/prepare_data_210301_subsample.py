...
data_out_paths = ["/home/jbraun/bin/deepinterpolation/sample_data/210301_001_crop_8Hz.tif",
                  "/home/jbraun/bin/deepinterpolation/sample_data/210301_002_crop_8Hz.tif",
                  ]
size_y = 320  # 320
# overlap = -64  # 0
...
for i_trial, (raw_data_path, data_out_path) in enumerate(zip(raw_data_paths, data_out_paths)):
    ...
    # only use every second frame to simulate a 8 Hz sampling rate
    stack_crop = stack[::2, offset_y:offset_y+size_y, offset_x:offset_x+size_x]
